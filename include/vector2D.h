...
namespace CGL
{
  ...
  // inner product
  CGL_EXPORT inline double dot(const Vector2D &v1, const Vector2D &v2)
  {
    return v1.x * v2.x + v1.y * v2.y;
  }

  // cross product
  CGL_EXPORT inline double cross(const Vector2D &v1, const Vector2D &v2)
  {
