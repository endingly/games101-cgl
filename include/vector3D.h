...
namespace CGL
{
  ...
  CGL_EXPORT inline double dot(const Vector3D &u, const Vector3D &v)
  {
    return u.x * v.x + u.y * v.y + u.z * v.z;
  }

  // cross product
  CGL_EXPORT inline Vector3D cross(const Vector3D &u, const Vector3D &v)
  {
